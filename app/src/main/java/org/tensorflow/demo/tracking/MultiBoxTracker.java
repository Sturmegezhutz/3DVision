...
import com.ivvi.ehvision.Classifier.Recognition;
import com.ivvi.ehvision.env.BorderedText;
import com.ivvi.ehvision.env.ImageUtils;
import com.ivvi.ehvision.env.Logger;
...
public class MultiBoxTracker {
  ...
  public org.tensorflow.demo.tracking.ObjectTracker objectTracker;

  final List<Pair<Float, RectF>> screenRects = new LinkedList<Pair<Float, RectF>>();

  private static class TrackedRecognition {
    org.tensorflow.demo.tracking.ObjectTracker.TrackedObject trackedObject;
    RectF location;
  ...
  public synchronized void onFrame(
    ...
    if (objectTracker == null && !initialized) {
      org.tensorflow.demo.tracking.ObjectTracker.clearInstance();

      logger.i("Initializing ObjectTracker: %dx%d", w, h);
      objectTracker = org.tensorflow.demo.tracking.ObjectTracker.getInstance(w, h, rowStride, true);
      frameWidth = w;
      frameHeight = h;
  ...
  private void handleDetection(
    ...
    final org.tensorflow.demo.tracking.ObjectTracker.TrackedObject potentialObject =
